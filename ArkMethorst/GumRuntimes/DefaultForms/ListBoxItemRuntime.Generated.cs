    ...
    {
        public partial class ListBoxItemRuntime : ArkMethorst.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentListBoxItemCategoryState)
                        {
                            case  ListBoxItemCategory.Enabled:
                                BackgroundInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                                RectangleInstance.Visible = false;
                                break;
                            case  ListBoxItemCategory.Highlighted:
                                BackgroundInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                BackgroundInstance.X = 0f;
                                BackgroundInstance.XOrigin = RenderingLibrary.Graphics.HorizontalAlignment.Center;
                                BackgroundInstance.XUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                                BackgroundInstance.Y = 0f;
                            ...
                            case  ListBoxItemCategory.Selected:
                                BackgroundInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                                RectangleInstance.Visible = false;
                                break;
            ...
            public void InterpolateBetween (ListBoxItemCategory firstState, ListBoxItemCategory secondState, float interpolationValue) 
            {
                ...
                ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateFirstValue= ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateSecondValue= ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                bool setBackgroundInstanceXFirstValue = false;
                bool setBackgroundInstanceXSecondValue = false;
                float BackgroundInstanceXFirstValue= 0;
                float BackgroundInstanceXSecondValue= 0;
                ...
                switch(firstState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        if (interpolationValue < 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                    ...
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXFirstValue = true;
                        BackgroundInstanceXFirstValue = 0f;
                        if (interpolationValue < 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        if (interpolationValue < 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                ...
                switch(secondState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        if (interpolationValue >= 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
                    ...
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXSecondValue = true;
                        BackgroundInstanceXSecondValue = 0f;
                        if (interpolationValue >= 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        if (interpolationValue >= 1)
                        {
                            this.RectangleInstance.Visible = false;
                        }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.ListBoxItemRuntime.VariableState fromState,ArkMethorst.GumRuntimes.DefaultForms.ListBoxItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.ListBoxItemRuntime.ListBoxItemCategory fromState,ArkMethorst.GumRuntimes.DefaultForms.ListBoxItemRuntime.ListBoxItemCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime BackgroundInstance { get; set; }
            public ArkMethorst.GumRuntimes.TextRuntime TextInstance { get; set; }
            public ArkMethorst.GumRuntimes.RectangleRuntime RectangleInstance { get; set; }
            ...
            {
                BackgroundInstance = this.GetGraphicalUiElementByName("BackgroundInstance") as ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as ArkMethorst.GumRuntimes.TextRuntime;
                RectangleInstance = this.GetGraphicalUiElementByName("RectangleInstance") as ArkMethorst.GumRuntimes.RectangleRuntime;
