    ...
    {
        public partial class TextBoxRuntime : ArkMethorst.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            SelectionInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory SelectionInstanceCurrentColorCategoryStateFirstValue= ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory SelectionInstanceCurrentColorCategoryStateSecondValue= ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        SelectionInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        SelectionInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.TextBoxRuntime.VariableState fromState,ArkMethorst.GumRuntimes.DefaultForms.TextBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.TextBoxRuntime.TextBoxCategory fromState,ArkMethorst.GumRuntimes.DefaultForms.TextBoxRuntime.TextBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.TextBoxRuntime.LineModeCategory fromState,ArkMethorst.GumRuntimes.DefaultForms.TextBoxRuntime.LineModeCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime SelectionInstance { get; set; }
            public ArkMethorst.GumRuntimes.TextRuntime TextInstance { get; set; }
            public ArkMethorst.GumRuntimes.ColoredRectangleRuntime CaretInstance { get; set; }
            public string Text
            {
                get
                {
            ...
            private void AssignReferences () 
            {
                ...
                SelectionInstance = this.GetGraphicalUiElementByName("SelectionInstance") as ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as ArkMethorst.GumRuntimes.TextRuntime;
                CaretInstance = this.GetGraphicalUiElementByName("CaretInstance") as ArkMethorst.GumRuntimes.ColoredRectangleRuntime;
