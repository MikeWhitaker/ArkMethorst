    ...
    {
        public partial class TreeViewItemRuntime : ArkMethorst.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.TreeViewItemRuntime.VariableState fromState,ArkMethorst.GumRuntimes.DefaultForms.TreeViewItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public ArkMethorst.GumRuntimes.DefaultForms.TreeViewToggleButtonRuntime ToggleButtonInstance { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.ListBoxItemRuntime ListBoxItemInstance { get; set; }
            ...
            {
                ToggleButtonInstance = this.GetGraphicalUiElementByName("ToggleButtonInstance") as ArkMethorst.GumRuntimes.DefaultForms.TreeViewToggleButtonRuntime;
                ListBoxItemInstance = this.GetGraphicalUiElementByName("ListBoxItemInstance") as ArkMethorst.GumRuntimes.DefaultForms.ListBoxItemRuntime;
