    ...
    {
        public partial class KeyboardKeyRuntime : ArkMethorst.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            TextInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                            Height = 20f;
                            Width = 20f;
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentButtonCategoryState)
                        {
                            case  ButtonCategory.Enabled:
                                KeyBackground.CurrentColorCategoryState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                                KeyBackground.CurrentVariableState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                                TextInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                                break;
                            case  ButtonCategory.Disabled:
                                KeyBackground.CurrentColorCategoryState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                KeyBackground.CurrentVariableState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                                TextInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Gray;
                                break;
                            case  ButtonCategory.Highlighted:
                                KeyBackground.CurrentColorCategoryState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                KeyBackground.CurrentVariableState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                                TextInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                                break;
                            case  ButtonCategory.Pushed:
                                KeyBackground.CurrentColorCategoryState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                                KeyBackground.CurrentVariableState = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                                TextInstance.CurrentColorCategoryState = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                                break;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                ArkMethorst.GumRuntimes.TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateFirstValue= ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ArkMethorst.GumRuntimes.TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateSecondValue= ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        TextInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        TextInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
            ...
            public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
            {
                ...
                ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory KeyBackgroundCurrentColorCategoryStateFirstValue= ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory KeyBackgroundCurrentColorCategoryStateSecondValue= ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                bool setKeyBackgroundCurrentVariableStateFirstValue = false;
                bool setKeyBackgroundCurrentVariableStateSecondValue = false;
                ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState KeyBackgroundCurrentVariableStateFirstValue= ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState KeyBackgroundCurrentVariableStateSecondValue= ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                bool setTextInstanceCurrentColorCategoryStateFirstValue = false;
                bool setTextInstanceCurrentColorCategoryStateSecondValue = false;
                ArkMethorst.GumRuntimes.TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateFirstValue= ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ArkMethorst.GumRuntimes.TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateSecondValue= ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Gray;
                switch(firstState)
                {
                    case  ButtonCategory.Enabled:
                        ...
                        KeyBackgroundCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        setKeyBackgroundCurrentVariableStateFirstValue = true;
                        KeyBackgroundCurrentVariableStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                        break;
                    case  ButtonCategory.Disabled:
                        setKeyBackgroundCurrentColorCategoryStateFirstValue = true;
                        KeyBackgroundCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setKeyBackgroundCurrentVariableStateFirstValue = true;
                        KeyBackgroundCurrentVariableStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Gray;
                        break;
                    case  ButtonCategory.Highlighted:
                        setKeyBackgroundCurrentColorCategoryStateFirstValue = true;
                        KeyBackgroundCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setKeyBackgroundCurrentVariableStateFirstValue = true;
                        KeyBackgroundCurrentVariableStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                    ...
                    case  ButtonCategory.Pushed:
                        setKeyBackgroundCurrentColorCategoryStateFirstValue = true;
                        KeyBackgroundCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        setKeyBackgroundCurrentVariableStateFirstValue = true;
                        KeyBackgroundCurrentVariableStateFirstValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  ButtonCategory.Enabled:
                        ...
                        KeyBackgroundCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        setKeyBackgroundCurrentVariableStateSecondValue = true;
                        KeyBackgroundCurrentVariableStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                        break;
                    case  ButtonCategory.Disabled:
                        setKeyBackgroundCurrentColorCategoryStateSecondValue = true;
                        KeyBackgroundCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setKeyBackgroundCurrentVariableStateSecondValue = true;
                        KeyBackgroundCurrentVariableStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Gray;
                        break;
                    case  ButtonCategory.Highlighted:
                        setKeyBackgroundCurrentColorCategoryStateSecondValue = true;
                        KeyBackgroundCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setKeyBackgroundCurrentVariableStateSecondValue = true;
                        KeyBackgroundCurrentVariableStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
                    ...
                    case  ButtonCategory.Pushed:
                        setKeyBackgroundCurrentColorCategoryStateSecondValue = true;
                        KeyBackgroundCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        setKeyBackgroundCurrentVariableStateSecondValue = true;
                        KeyBackgroundCurrentVariableStateSecondValue = ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = ArkMethorst.GumRuntimes.TextRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime.VariableState fromState,ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime.ButtonCategory fromState,ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime KeyBackground { get; set; }
            public ArkMethorst.GumRuntimes.TextRuntime TextInstance { get; set; }
            public string Text
            {
                get
                {
            ...
            {
                KeyBackground = this.GetGraphicalUiElementByName("KeyBackground") as ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as ArkMethorst.GumRuntimes.TextRuntime;
