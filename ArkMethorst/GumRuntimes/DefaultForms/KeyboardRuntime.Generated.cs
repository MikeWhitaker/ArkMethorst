    using System.Linq;
    namespace ArkMethorst.GumRuntimes.DefaultForms
    {
        public partial class KeyboardRuntime : ArkMethorst.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.KeyboardRuntime.VariableState fromState,ArkMethorst.GumRuntimes.DefaultForms.KeyboardRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.KeyboardRuntime.CursorMoveCategory fromState,ArkMethorst.GumRuntimes.DefaultForms.KeyboardRuntime.CursorMoveCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArkMethorst.GumRuntimes.ContainerRuntime Row1Keys { get; set; }
            public ArkMethorst.GumRuntimes.ContainerRuntime KeyRows { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key1 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyQ { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyA { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyZ { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyParenLeft { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyW { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyS { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyX { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyParenRight { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyE { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyD { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyC { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeySpace { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyR { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyF { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyV { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyT { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyG { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyB { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyY { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyH { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyN { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyU { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyJ { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyM { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyI { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyK { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyComma { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyQuestion { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyO { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyL { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyPeriod { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyBang { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyP { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyUnderscore { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyHyphen { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyAmpersand { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key2 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key3 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key4 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key5 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key6 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key7 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key8 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key9 { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key0 { get; set; }
            public ArkMethorst.GumRuntimes.ContainerRuntime Row2Keys { get; set; }
            public ArkMethorst.GumRuntimes.ContainerRuntime Row3Keys { get; set; }
            public ArkMethorst.GumRuntimes.ContainerRuntime Row4Keys { get; set; }
            public ArkMethorst.GumRuntimes.ContainerRuntime Row5Keys { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.ButtonRuntime KeyBackspace { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.ButtonRuntime KeyReturn { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyLeft { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyRight { get; set; }
            ...
            {
                Row1Keys = this.GetGraphicalUiElementByName("Row1Keys") as ArkMethorst.GumRuntimes.ContainerRuntime;
                KeyRows = this.GetGraphicalUiElementByName("KeyRows") as ArkMethorst.GumRuntimes.ContainerRuntime;
                Key1 = this.GetGraphicalUiElementByName("Key1") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyQ = this.GetGraphicalUiElementByName("KeyQ") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyA = this.GetGraphicalUiElementByName("KeyA") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyZ = this.GetGraphicalUiElementByName("KeyZ") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyParenLeft = this.GetGraphicalUiElementByName("KeyParenLeft") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyW = this.GetGraphicalUiElementByName("KeyW") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyS = this.GetGraphicalUiElementByName("KeyS") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyX = this.GetGraphicalUiElementByName("KeyX") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyParenRight = this.GetGraphicalUiElementByName("KeyParenRight") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyE = this.GetGraphicalUiElementByName("KeyE") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyD = this.GetGraphicalUiElementByName("KeyD") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyC = this.GetGraphicalUiElementByName("KeyC") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeySpace = this.GetGraphicalUiElementByName("KeySpace") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyR = this.GetGraphicalUiElementByName("KeyR") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyF = this.GetGraphicalUiElementByName("KeyF") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyV = this.GetGraphicalUiElementByName("KeyV") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyT = this.GetGraphicalUiElementByName("KeyT") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyG = this.GetGraphicalUiElementByName("KeyG") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyB = this.GetGraphicalUiElementByName("KeyB") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyY = this.GetGraphicalUiElementByName("KeyY") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyH = this.GetGraphicalUiElementByName("KeyH") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyN = this.GetGraphicalUiElementByName("KeyN") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyU = this.GetGraphicalUiElementByName("KeyU") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyJ = this.GetGraphicalUiElementByName("KeyJ") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyM = this.GetGraphicalUiElementByName("KeyM") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyI = this.GetGraphicalUiElementByName("KeyI") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyK = this.GetGraphicalUiElementByName("KeyK") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyComma = this.GetGraphicalUiElementByName("KeyComma") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyQuestion = this.GetGraphicalUiElementByName("KeyQuestion") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyO = this.GetGraphicalUiElementByName("KeyO") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyL = this.GetGraphicalUiElementByName("KeyL") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyPeriod = this.GetGraphicalUiElementByName("KeyPeriod") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyBang = this.GetGraphicalUiElementByName("KeyBang") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyP = this.GetGraphicalUiElementByName("KeyP") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyUnderscore = this.GetGraphicalUiElementByName("KeyUnderscore") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyHyphen = this.GetGraphicalUiElementByName("KeyHyphen") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyAmpersand = this.GetGraphicalUiElementByName("KeyAmpersand") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key2 = this.GetGraphicalUiElementByName("Key2") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key3 = this.GetGraphicalUiElementByName("Key3") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key4 = this.GetGraphicalUiElementByName("Key4") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key5 = this.GetGraphicalUiElementByName("Key5") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key6 = this.GetGraphicalUiElementByName("Key6") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key7 = this.GetGraphicalUiElementByName("Key7") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key8 = this.GetGraphicalUiElementByName("Key8") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key9 = this.GetGraphicalUiElementByName("Key9") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key0 = this.GetGraphicalUiElementByName("Key0") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Row2Keys = this.GetGraphicalUiElementByName("Row2Keys") as ArkMethorst.GumRuntimes.ContainerRuntime;
                Row3Keys = this.GetGraphicalUiElementByName("Row3Keys") as ArkMethorst.GumRuntimes.ContainerRuntime;
                Row4Keys = this.GetGraphicalUiElementByName("Row4Keys") as ArkMethorst.GumRuntimes.ContainerRuntime;
                Row5Keys = this.GetGraphicalUiElementByName("Row5Keys") as ArkMethorst.GumRuntimes.ContainerRuntime;
                KeyBackspace = this.GetGraphicalUiElementByName("KeyBackspace") as ArkMethorst.GumRuntimes.DefaultForms.ButtonRuntime;
                KeyReturn = this.GetGraphicalUiElementByName("KeyReturn") as ArkMethorst.GumRuntimes.DefaultForms.ButtonRuntime;
                KeyLeft = this.GetGraphicalUiElementByName("KeyLeft") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyRight = this.GetGraphicalUiElementByName("KeyRight") as ArkMethorst.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
