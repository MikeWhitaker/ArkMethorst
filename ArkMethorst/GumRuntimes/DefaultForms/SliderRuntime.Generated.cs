    ...
    {
        public partial class SliderRuntime : ArkMethorst.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.SliderRuntime.VariableState fromState,ArkMethorst.GumRuntimes.DefaultForms.SliderRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory fromState,ArkMethorst.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime LineInstance { get; set; }
            public ArkMethorst.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public ArkMethorst.GumRuntimes.ContainerRuntime TrackInstance { get; set; }
            ...
            {
                LineInstance = this.GetGraphicalUiElementByName("LineInstance") as ArkMethorst.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                ...
                TrackInstance = this.GetGraphicalUiElementByName("TrackInstance") as ArkMethorst.GumRuntimes.ContainerRuntime;
