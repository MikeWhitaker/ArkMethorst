    ...
    {
        public partial class ButtonRuntime : ArkMethorst.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.ButtonRuntime.VariableState fromState,ArkMethorst.GumRuntimes.DefaultForms.ButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.ButtonRuntime.ButtonCategory fromState,ArkMethorst.GumRuntimes.DefaultForms.ButtonRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArkMethorst.GumRuntimes.RectangleRuntime HighlightRectangle { get; set; }
            public string Text
            {
                get
                {
            ...
            private void AssignReferences () 
            {
                ...
                HighlightRectangle = this.GetGraphicalUiElementByName("HighlightRectangle") as ArkMethorst.GumRuntimes.RectangleRuntime;
