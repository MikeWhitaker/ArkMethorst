    ...
    {
        public partial class ScrollViewerRuntime : ArkMethorst.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.ScrollViewerRuntime.VariableState fromState,ArkMethorst.GumRuntimes.DefaultForms.ScrollViewerRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArkMethorst.GumRuntimes.DefaultForms.ScrollViewerRuntime.ScrollBarVisibility fromState,ArkMethorst.GumRuntimes.DefaultForms.ScrollViewerRuntime.ScrollBarVisibility toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArkMethorst.GumRuntimes.DefaultForms.ScrollBarRuntime VerticalScrollBarInstance { get; set; }
            public ArkMethorst.GumRuntimes.ContainerRuntime ClipContainerInstance { get; set; }
            public ArkMethorst.GumRuntimes.ContainerRuntime InnerPanelInstance { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                VerticalScrollBarInstance = this.GetGraphicalUiElementByName("VerticalScrollBarInstance") as ArkMethorst.GumRuntimes.DefaultForms.ScrollBarRuntime;
                ClipContainerInstance = this.GetGraphicalUiElementByName("ClipContainerInstance") as ArkMethorst.GumRuntimes.ContainerRuntime;
                InnerPanelInstance = this.GetGraphicalUiElementByName("InnerPanelInstance") as ArkMethorst.GumRuntimes.ContainerRuntime;
