...
{
    public partial class EndOfLevel : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public EndOfLevel (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public EndOfLevel (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void Destroy () 
        {
            ...
            if (Used)
            {
                Factories.EndOfLevelFactory.MakeUnused(this, false);
            }
        ...
        public virtual void PostInitialize () 
        {
            ...
            SpriteInstance.CurrentChainName = "DoorClosed";
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("EndOfLevelStaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/endoflevel/animationchainlistfile.achx", ContentManagerName))
                {
                    registerUnload = true;
                }
                AnimationChainListFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/endoflevel/animationchainlistfile.achx", ContentManagerName);
            }
